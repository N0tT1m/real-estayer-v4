...
pub(crate) async fn wait_for_elements(driver: &WebDriver, by: By, timeout_secs: u64) -> Result<Vec<WebElement>> {
...
pub(crate) async fn extract_data_fallback(page_source: &str, driver: &WebDriver) -> Result<(String, String, String, String, String, String, Vec<String>)> {
    use tracing::debug;
